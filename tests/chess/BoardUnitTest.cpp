...
namespace BoardUnitTest {
    TEST(Board, constructorInitializesEmptyBoard) {
        auto board = Board();
        ASSERT_EQ("8/8/8/8/8/8/8/8", fen(board));
    }

    TEST(Board, startingBoard) {
        auto board = Board::startingBoard();
        ASSERT_EQ("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR", fen(board));
    }
    ...
    TEST(Board, makeMoveNoCapture) {
        ...
        ASSERT_EQ("rnbqkbnr/pppppppp/8/8/4P3/8/PPPP1PPP/RNBQKBNR", fen(board));
    ...
    TEST(Board, makeMoveCapture) {
        auto board = fenBoard("rnbqkbnr/pppp1ppp/8/4p3/8/5N2/PPPPPPPP/RNBQKB1R");
        ...
        ASSERT_EQ("rnbqkbnr/pppp1ppp/8/4N3/8/8/PPPPPPPP/RNBQKB1R", fen(board));
