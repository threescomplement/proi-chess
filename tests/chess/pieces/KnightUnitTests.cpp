...
namespace KnightUnitTests {
    TEST(Knight, getMovesStartingPosition) {
        auto board = fenBoard("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR");
    ...
    TEST(Knight, getMovesMultiplePossibleNoCapture) {
        auto board = fenBoard("rnbqkbnr/1ppppppp/p7/8/8/5N2/PPPPPPPP/RNBQKB1R");
    ...
    TEST(Knight, getMovesMultipleCaptures) {
        auto board = fenBoard("rnbqkbnr/1ppppp1p/p5p1/4N3/8/8/PPPPPPPP/RNBQKB1R");
